...
const CreateCustomMeetingsWithPic: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Toast
        ...
        message="Your custom meetings with picture template has been created and saved. You can now use it in your campaigns."
        duration={4000}
...
export default CreateCustomMeetingsWithPic;
