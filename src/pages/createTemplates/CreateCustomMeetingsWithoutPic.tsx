...
const CreateCustomMeetingsWithoutPic: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Toast
        ...
        message="Your custom meetings without picture template has been created and saved. You can now use it in your campaigns."
        duration={4000}
...
export default CreateCustomMeetingsWithoutPic;
