...
const EditCustomMeetingsWithPic: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Toast
        ...
        message="Your custom meetings with picture template has been updated and saved."
        duration={4000}
...
export default EditCustomMeetingsWithPic;
